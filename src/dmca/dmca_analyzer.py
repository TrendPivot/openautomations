...
class DMCAAnalyzer:
    ...
    def convert_rarible_url(self, url: str) -> str:
        ...
        rarible_main_pattern = r'https://((?:beta\.|testnet\.|og\.)?rarible\.com)/(user|token|collection)/(?:(ethereum|polygon|mantle|immutablex|flow|arbitrum|chiliz|lightlink|celo|zksync|base|rari|astarzkevm|kroma|xai|sei|oasys|saakuru|palm|lisk|etherlink|moonbeam|fivire|match|alephzero|aptos|shape|eclipse|telos|solana|abstract|berachain|apechain|arenaz|basecamptestnet|crossfi|goat|hederaevm|hyperevm|megaeth-?testnet|settlus|somniatestnet|viction|zkcandy)/)?([a-zA-Z0-9-]+)(?::([a-zA-Z0-9]+))?/?(?:owned|items)?/?$'
        ...
        rarible_chain_first_pattern = r'https://((?:beta\.|testnet\.|og\.)?rarible\.com)/([a-zA-Z0-9-]+)/(collections|items)/([a-zA-Z0-9x]+)(?::([a-zA-Z0-9]+))?(?:/.*)?(?:\?.*)?$'
        ...
        rarible_simple_pattern = r'(?:beta\.|testnet\.|og\.)?rarible\.com/collection/(ethereum|polygon|mantle|immutablex|flow|arbitrum|chiliz|lightlink|celo|zksync|base|rari|astarzkevm|kroma|xai|sei|oasys|saakuru|palm|lisk|etherlink|moonbeam|fivire|match|alephzero|aptos|shape|eclipse|telos|solana|abstract|berachain|apechain|arenaz|basecamptestnet|crossfi|goat|hederaevm|hyperevm|megaeth-?testnet|settlus|somniatestnet|viction|zkcandy)/([a-zA-Z0-9]+)/?(?:items)?$'
    ...
    def convert_url(self, url: str) -> str:
        ...
        if 'rarible.com' in url or 'og.rarible.com' in url:
